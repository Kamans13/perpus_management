...
$query_peminjaman = "SELECT p.kode_peminjaman, 
                            a.nama AS peminjam, 
                            p.tanggal_pinjam, 
                            p.tanggal_kembali, 
                            p.status
                                                ...
                                                echo "<tr>
                                                        ...
                                                        <td>
                                                            <div class='d-flex justify-content-center gap-2'>
                                                                <a href='detail_pengembalian.php?kode_peminjaman={$kode_peminjaman}'class='btn btn-primary btn-sm'><i class='far fa-eye'></i> Detail </a>
                                                            </div>    
                                                        </td>
                                                    </tr>";
