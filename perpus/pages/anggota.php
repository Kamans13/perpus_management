...
if (isset($_POST['tambah'])) {
    $nama = $_POST['nama'];
    $alamat = $_POST['alamat'];
    $tanggabung = $_POST['tanggabung'];
    $email = $_POST['email'];
    $notelp = $_POST['notelp'];

    $sql = "INSERT INTO anggota (nama, alamat, tanggabung, email, notelp) 
            VALUES ('$nama', '$alamat', '$tanggabung', '$email', '$notelp')";
    if ($conn->query($sql)) {
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <input type="date" name="tanggabung" placeholder="Tanggal Bergabung" required>
