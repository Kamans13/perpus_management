                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Katgeori Buku</li>
                        </ol>
                        <div class="card mb-4">
                                             ...
                                             echo "<tr>
                                                 ...
                                                 <td>
                                                     <div class='d-flex justify-content-center gap-2'>
                                                        <a href='edit.php?id_kategori={$row['id_kategori']}' class='btn btn-warning btn-sm'><i class='fas fa-pencil-square'></i> Edit </a>
